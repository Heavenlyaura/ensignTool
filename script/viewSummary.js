...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const displayCourses = uncompletedCourses.filter(
    (course) => !addedCourses.includes(course.courseCode)
  );
  ...
  if (storedCourses) {
    ...
    displayCourses.forEach((course) => {
      ...
      uncompleted += `<span class="uncompleteBody ${certificates} ${religions} ${capstones} ${internships}">
